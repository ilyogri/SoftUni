...
Write a query that returnsall unique wizard first letters of their **first names** only if they have deposit of type Troll Chest. Order them alphabetically. Use GROUP BY for uniqueness.
